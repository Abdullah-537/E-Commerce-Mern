(function(factory) {
    ...
    const tooltipFormatter = (t, e = "MMM DD") => {
        let s = "";
        return t.forEach((t => {
            s += `<div class='ms-1'>\n        <h6 class="text-body-tertiary"><span class="fas fa-circle me-1 fs-10" style="color:${t.borderColor?t.borderColor:t.color}"></span>\n          ${t.seriesName} : ${"object"==typeof t.value?t.value[1]:t.value}\n        </h6>\n      </div>`;
        })), `<div>\n            <p class='mb-2 text-body-tertiary'>\n              ${window.dayjs(t[0].axisValue).isValid()?window.dayjs(t[0].axisValue).format(e):t[0].axisValue}\n            </p>\n            ${s}\n          </div>`
    };
    ...
    const newCustomersChartsInit = () => {
        const {
            ...
            const e = window.dayjs(o[0].axisValue),
                t = window.dayjs(o[0].axisValue).subtract(1, "month"),
                a = o.map(((o, a) => ({
                    value: o.value,
                    date: a > 0 ? t : e,
                    color: o.color
            ...
            return a.forEach(((o, e) => {
                i += `<h6 class="fs-9 text-body-tertiary ${e>0&&"mb-0"}"><span class="fas fa-circle me-2" style="color:${o.color}"></span>\n      ${o.date.format("MMM DD")} : ${o.value}\n    </h6>`;
            })), `<div class='ms-1'>\n              ${i}\n            </div>`
        };
        if (a) {
            const r = e(a, "echarts"),
            ...
            echartSetOption(s, r, (() => ({
                ...
                xAxis: [{
                    type: "category",
                    data: t(new Date("5/1/2022"), new Date("5/7/2022"), 864e5),
                    show: !0,
                    boundaryGap: !1,
                    axisLine: {
                        show: !0,
    ...
    const totalOrdersChartInit = () => {
        const {
            ...
            getData: o,
            getDates: e
        } = window.phoenix.utils, r = document.querySelector(".echart-total-orders");
        if (r) {
            const a = o(r, "echarts"),
    ...
    window.revenueMapInit = revenueMapInit, docReady(totalSalesChartInit), docReady(newCustomersChartsInit), docReady(topCouponsChartInit), docReady(projectionVsActualChartInit), docReady(returningCustomerChartInit), docReady(payingCustomerChartInit), docReady(totalOrdersChartInit), docReady(leafletInit);
