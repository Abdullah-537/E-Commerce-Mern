(function(global, factory) {
    ...
    class BulkSelect {
        ...
        toggleDisplay(e, t) {
            (e || t) && (e.classList.toggle(this.option.displayNoneClassName), t.classList.toggle(this.option.displayNoneClassName)), this.actions.toggleClass(this.option.displayNoneClassName), this.replacedElement.toggleClass(this.option.displayNoneClassName);
        }
        deselectAll(e, t) {
            this.removeBulkCheck(), this.toggleDisplay(e, t), this.bulkSelectRows.forEach((e => {
    ...
    const echartSetOption = (t, e, s, n) => {
        ...
        i && i.addEventListener("navbar.vertical.toggle", (() => {
            ...
            t.resize(), n && l(n);
        })), n && l(n), r.addEventListener("clickControl", (({
            detail: {
                control: o
            }
        }) => {
    ...
    echartTabs && echartTabs.forEach((t => {
        t.addEventListener("shown.bs.tab", (t => {
            const e = t.target,
                ...
                o = document.getElementById(n.substring(1))?.querySelector("[data-echart-tab]");
                ...
                return document.querySelectorAll(".needs-validation").forEach((e => {
                    const i = () => {
                        e.querySelectorAll(".choices").forEach((e => {
                            ...
                            if (e.querySelector("[required]") && (i && ("" !== i.querySelector(".choices__item--selectable")?.getAttribute("data-value") ? (e.classList.remove("invalid"), e.classList.add("valid")) : (e.classList.remove("valid"), e.classList.add("invalid"))), s)) {
                                const {
                                    selectedOptions: i
                                } = t;
                                i.length > 0 && [...i].some((e => "" !== e.value)) ? (e.classList.remove("invalid"), e.classList.add("valid")) : (e.classList.remove("valid"), e.classList.add("invalid"));
                            }
                        }));
                    };
    ...
    const isotopeInit = () => {
        const {
            getData: e
        } = window.phoenix.utils, t = ".isotope-item", o = "[data-sl-isotope]", l = "[data-filter]", a = "[data-filter-nav]", r = "[data-gallery-column]", s = "sl-isotope", n = "active";
        if (window.Isotope) {
            ...
            c.length && c.forEach((o => {
                window.imagesLoaded(o, (() => {
                    ...
                    return document.querySelector(a)?.addEventListener("click", (e => {
                        ...
                        i && document.querySelectorAll('span[class*="gallery-column-separator-"]').forEach((e => e.remove())), setTimeout((() => {
    ...
    const phoenixOffcanvasInit = () => {
        const {
            getData: e
        } = window.phoenix.utils, o = document.querySelectorAll("[data-phoenix-toggle='offcanvas']"), t = document.querySelectorAll("[data-phoenix-backdrop]"), n = document.querySelector("[data-phoenix-scroll]"), a = document.querySelectorAll(".phoenix-offcanvas"), c = document.querySelector(".faq"), s = document.querySelector(".faq-sidebar");
        if (a) {
            const e = {
                sm: 576,
                md: 768,
    ...
    const responsiveNavItemsInit = () => {
        const {
            resize: e
        } = window.phoenix.utils, t = "[data-nav-item]", l = "[data-navbar]", s = "[data-more-item]", o = "[data-category-list]", i = "[data-category-btn]", n = document.querySelector(l), a = () => {
            ...
            l.style.display = "none", r.forEach((e => {
                const t = e.clientWidth;
                if (d += t, e.classList.contains("dropdown") || e.classList.remove("invisible"), d + (c || 0) + o > a && !e.classList.contains("dropdown")) {
    ...
    const {
        ...
        e && e.querySelectorAll("[data-theme-control]").forEach((e => {
            ...
            if ("phoenixNavbarVerticalStyle" === n && ("horizontal" === c || "dual-nav" === c) && e.setAttribute("disabled", !0), "checkbox" === e.type) "phoenixTheme" === n ? ("auto" === r ? "dark" === o() : "dark" === r) && e.setAttribute("checked", !0) : r && e.setAttribute("checked", !0);
    ...
    const themeControl = () => {
        ...
        }, n = new DomNode(document.body), r = document.querySelector(".navbar-vertical"), c = document.querySelector(".navbar-top"), i = document.querySelector(".support-chat-container");
        initialDomSetup(n.node), n.on("click", (e => {
            ...
            if (d.data("theme-control")) {
                ...
                "phoenixTheme" === l && "boolean" == typeof h && (h = h ? "dark" : "light"), config.hasOwnProperty(l) && window.config.set({
                    [l]: h
                });
    ...
    const mapboxInit = () => {
            ...
            o && o.forEach((o => {
                window.mapboxgl.accessToken = "REMOVED_TOKEN";
    ...
    const playOnHoverInit = () => {
        const e = (e, t) => {
                e && t && (e.classList.add("d-block"), t.classList.add("d-none"), e.classList.remove("d-none"), t.classList.remove("d-block"));
            },
            t = (e, t, o) => {
                e.play(), ((e, t) => {
                    e && t && (e.classList.add("d-none"), t.classList.add("d-block"), e.classList.remove("d-block"), t.classList.remove("d-none"));
                })(t, o);
            },
            o = (t, o, a) => {
                t.pause(), e(o, a);
    ...
    const treeviewInit = () => {
        const e = "change",
            ...
            L = e => {
                Array.from(e.querySelectorAll(s)).filter((e => {
                    let t = !0;
                    for (; e.parentElement;) {
        ...
        E.length && E.forEach((s => {
            ...
            Array.from(s.querySelectorAll(i)).forEach((e => {
                ...
                const a = o.id;
                if (f || o.classList.add(w), o.addEventListener(t, (e => {
                    ...
                    e.forEach((e => {
                        new window.bootstrap.Collapse(e, {
                            show: !0
                        });
                    }));
                }
