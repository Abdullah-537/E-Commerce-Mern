...
<div className="ecommerce-homepage pt-5 mb-9">
        ...
        <div className="container px-xl-0 px-xxl-3">
          <div className="row g-3 mb-9">
            <div className="col-12">
              <div className="whooping-banner w-100 rounded-3 overflow-hidden">
                ...
                <a className="btn btn-lg btn-primary rounded-pill banner-button" href="#!">Shop Now</a>
              </div>
            </div>
            <div className="col-12 col-xl-6">
              <div className="gift-items-banner w-100 rounded-3 overflow-hidden">
                ...
                <div className="banner-text text-md-center">
                  ...
                  <a className="btn btn-lg btn-primary rounded-pill banner-button" href="#!">Buy Now</a>
                </div>
              </div>
            </div>
            <div className="col-12 col-xl-6">
              <div className="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-3 overflow-hidden">
                <div className="bg-holder z-n1 banner-bg"
                  style={{"backgroundImage":"url(/assets/img/e-commerce/best-in-market-bg.png)"}}>
                </div>
                <!--/.bg-holder-->
                  ...
                  <div className="col-8">
                    <div className="banner-text">
                      <h2 className="text-white fw-bolder fs-sm-4 mb-5">
                        MI 11 Pro<br /><span className="fs-7 fs-sm-6">
                          Best in the market</span>
                      </h2>
                      <a className="btn btn-lg btn-warning rounded-pill banner-button" href="#!">Buy Now</a>
                    </div>
                  </div>
                  <div className="col-4">
          ...
          <div className="row g-4 mb-6">
            <div className="col-12 col-lg-9 col-xxl-10">
              <div className="d-flex flex-between-center mb-3">
                ...
                <a className="btn btn-link btn-lg p-0 d-none d-md-block" href="#!">Explore more<span
                    className="fas fa-chevron-right fs-9 ms-1"></span></a>
              </div>
                          ...
                          <div>
                            <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                              <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                ...
                                <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                  className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                                className="img-fluid" src="/assets/img/products/6.png" alt="" />
                            </div>
                            <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            ...
                            <p className="fs-9">
                              ...
                              <span className="text-body-quaternary fw-semibold ms-1">(67 people rated)</span>
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                              <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                ...
                                <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                  className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                                className="img-fluid" src="/assets/img/products/1.png" alt="" /><span
                                className="badge text-bg-success fs-10 product-verified-badge">Verified<span
                                  className="fas fa-check ms-1"></span></span>
                            </div>
                            <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                              <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                            ...
                            <p className="fs-9">
                              <span className="fa fa-star text-warning"></span><span
                                ...
                                className="fa fa-star text-warning"></span><span
                                className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                              <span className="text-body-quaternary fw-semibold ms-1">(74 people rated)</span>
                            </p>
                          </div>
                          <div>
                            <div className="d-flex align-items-center mb-1">
                          ...
                          <div>
                            <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                              <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                ...
                                <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                  className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                                className="img-fluid" src="/assets/img/products/2.png" alt="" />
                            </div>
                            <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                              <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                            ...
                            <p className="fs-9">
                              <span className="fa fa-star text-warning"></span><span
                                ...
                                className="fa fa-star text-warning"></span><span
                                className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                              <span className="text-body-quaternary fw-semibold ms-1">(33 people rated)</span>
                            </p>
                          </div>
                          <div>
                            <p className="fs-9 text-body-highlight fw-bold mb-2">
                          ...
                          <div>
                            <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                              <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                ...
                                <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                  className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                                className="img-fluid" src="/assets/img/products/3.png" alt="" />
                            </div>
                            <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                              <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                            ...
                            <p className="fs-9">
                              <span className="fa fa-star text-warning"></span><span
                                ...
                                className="fa fa-star text-warning"></span><span
                                className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                              <span className="text-body-quaternary fw-semibold ms-1">(97 people rated)</span>
                            </p>
                          </div>
                          <div>
                            <p className="fs-9 text-body-highlight fw-bold mb-2">
                          ...
                          <div>
                            <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                              <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                ...
                                <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                  className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                                className="img-fluid" src="/assets/img/products/4.png" alt="" />
                            </div>
                            <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                              <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                            ...
                            <p className="fs-9">
                              <span className="fa fa-star text-warning"></span><span
                                ...
                                className="fa fa-star text-warning"></span><span
                                className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                              <span className="text-body-quaternary fw-semibold ms-1">(134 people rated)</span>
                            </p>
                          </div>
                          <div>
                            <p className="fs-9 text-body-highlight fw-bold mb-2">
                          ...
                          <div>
                            <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                              <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                ...
                                <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                  className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                                className="img-fluid" src="/assets/img/products/5.png" alt="" />
                            </div>
                            <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                              <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                            ...
                            <p className="fs-9">
                              <span className="fa fa-star text-warning"></span><span
                                ...
                                className="fa fa-star text-warning"></span><span
                                className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                              <span className="text-body-quaternary fw-semibold ms-1">(59 people rated)</span>
                            </p>
                          </div>
                          <div>
              ...
              <a className="fw-bold d-md-none px-0" href="#!">Explore more<span
                  className="fas fa-chevron-right fs-9 ms-1"></span></a>
            </div>
            ...
            <div className="col-12 d-lg-none">
              <a href="#!"><img className="w-100 rounded-3" src="/assets/img/e-commerce/6.png" alt="" /></a>
            </div>
          </div>
          <div className="mb-6">
            <div className="d-flex flex-between-center mb-3">
              <h3>Top Electronics</h3>
              <a className="fw-bold d-none d-md-block" href="#!">Explore more<span
                  className="fas fa-chevron-right fs-9 ms-1"></span></a>
            </div>
            <div className="swiper-theme-container products-slider">
              <div className="swiper swiper theme-slider"
                    ...
                    <div className="position-relative text-decoration-none product-card h-100">
                      <div className="d-flex flex-column justify-content-between h-100">
                        <div>
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                            <span className="text-body-quaternary fw-semibold ms-1">(59 people rated)</span>
                          </p>
                        </div>
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/7.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                            <span className="text-body-quaternary fw-semibold ms-1">(13 people rated)</span>
                          </p>
                        </div>
                        <div>
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/12.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                            <span className="text-body-quaternary fw-semibold ms-1">(64 people rated)</span>
                          </p>
                        </div>
                        <div>
                  ...
                  <div className="swiper-slide">
                    <div className="position-relative text-decoration-none product-card h-100">
                      <div className="d-flex flex-column justify-content-between h-100">
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container active"
                              data-bs-toggle="tooltip" data-bs-placement="top" title="Remove from wishlist">
                              <span className="fas fa-heart" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/1.png" alt="" /><span
                              className="badge text-bg-success fs-10 product-verified-badge">Verified<span
                                className="fas fa-check ms-1"></span></span>
                          </div>
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                            <span className="text-body-quaternary fw-semibold ms-1">(32 people rated)</span>
                          </p>
                        </div>
                        <div>
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/16.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                              Apple AirPods Pro
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span>
                            <span className="text-body-quaternary fw-semibold ms-1">(39 people rated)</span>
                          </p>
                        </div>
                        <div>
                          <p className="fs-9 text-body-highlight fs-9 mb-0 fw-bold">
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/10.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span
                              className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                            <span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span
                              className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span
                              className="text-body-quaternary fw-semibold ms-1">(6 people rated)</span>
                          </p>
                        </div>
                        <div>
                          <p className="fs-9 text-body-highlight fs-9 mb-0 fw-bold">
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/8.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              ...
                              className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                            <span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span
                              className="text-body-quaternary fw-semibold ms-1">(7 people rated)</span>
                          </p>
                        </div>
                        <div>
            ...
            <a className="fw-bold d-md-none" href="#!">Explore more<span className="fas fa-chevron-right fs-9 ms-1"></span></a>
          </div>
          <div className="mb-6">
            <div className="d-flex flex-between-center mb-3">
              <h3>Best Offers</h3>
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/25.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/27.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light"
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/26.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/18.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                          ...
                          <p className="fs-9">
                            <span className="fa fa-star text-warning"></span><span
                              className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span
                              className="fa fa-star-half-alt star-icon text-warning"></span>
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/17.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
                              Xbox Series S
                        ...
                        <div>
                          <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                            <button className="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                              ...
                              <span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span
                                className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img
                              className="img-fluid" src="/assets/img/products/24.png" alt="" />
                          </div>
                          <a className="stretched-link" href="/apps/e-commerce/landing/product-details.html">
                            <h6 className="mb-2 lh-sm line-clamp-3 product-name">
          ...
          <div className="row flex-center mb-15 mt-11 gy-6">
            <div className="col-auto">
              <img className="d-dark-none" src="/assets/img/spot-illustrations/light_30.png" alt=""
                width="305" /><img className="d-light-none" src="/assets/img/spot-illustrations/dark_30.png" alt=""
                width="305" />
            </div>
            <div className="col-auto">
              <div className="text-center text-lg-start">
                ...
                <a className="btn btn-lg btn-primary px-7" href="/pages/authentication/simple/sign-up.html">Sign
                  up<span className="fas fa-chevron-right ms-2 fs-9"></span></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="support-chat-container">
        ...
        <div className="card bg-body-emphasis">
          <div className="card-header d-flex flex-between-center px-4 py-3 border-bottom border-translucent">
            ...
            <div className="btn-reveal-trigger">
              ...
              <div className="dropdown-menu dropdown-menu-end py-2" aria-labelledby="support-chat-dropdown">
                <a className="dropdown-item" href="#!">Request a callback</a><a className="dropdown-item" href="#!">Search in
                  chat</a><a className="dropdown-item" href="#!">Show history</a><a className="dropdown-item" href="#!">Report
                  to Admin</a><a className="dropdown-item btn-support-chat" href="#!">Close Support</a>
              </div>
            </div>
          </div>
            ...
            <div className="d-flex flex-column-reverse scrollbar h-100 p-3">
              ...
              <div className="text-center mt-auto">
                <div className="avatar avatar-3xl status-online">
                  <img className="rounded-circle border border-3 border-light-subtle" src="/assets/img/team/30.webp"
                    alt="" />
                </div>
          ...
          <div className="card-footer d-flex align-items-center gap-2 border-top border-translucent ps-3 pe-4 py-3">
            <div className="d-flex align-items-center flex-1 gap-3 border border-translucent rounded-pill px-4">
              <input className="form-control outline-none border-0 flex-1 fs-9 px-0" type="text"
                placeholder="Write message" /><label className="btn btn-link d-flex p-0 text-body-quaternary fs-9 border-0"
                htmlFor="supportChatPhotos"><span className="fa-solid fa-image"></span></label><input className="d-none" type="file"
                accept="image/*" id="supportChatPhotos" /><label
                className="btn btn-link d-flex p-0 text-body-quaternary fs-9 border-0" htmlFor="supportChatAttachment">
                <span className="fa-solid fa-paperclip"></span></label><input className="d-none" type="file"
      ...
      <button className="btn btn-support-chat p-0 border border-translucent">
        <span className="fs-8 btn-text text-primary text-nowrap">Chat demo</span><span
          className="ping-icon-wrapper mt-n4 ms-n6 mt-sm-0 ms-sm-2 position-absolute position-sm-relative"><span
            className="ping-icon-bg"></span><span className="fa-solid fa-circle ping-icon"></span></span><span
          className="fa-solid fa-headset text-primary fs-8 d-sm-none"></span><span
          className="fa-solid fa-chevron-down text-primary fs-7"></span>
      </button>
    </div>
