...
const seed = async () => {
  try {
    ...
    saleEnds.setDate(saleEnds.getDate() + 2);

    await Product.insertMany([
      // TechHub Products
      {
        vendorId: techHub._id,
        ...
        salePrice: 320000,
        saleEndsAt: saleEnds,
        images: ['/assets/img/products/60x60/1.png'],
        stock: 10,
        isFeatured: true,
      ...
      },
      {
        ...
        price: 280000,
        images: ['/assets/img/products/60x60/2.png'],
        stock: 5,
      ...
      },
      {
        ...
        price: 45000,
        images: ['/assets/img/products/60x60/3.png'],
        stock: 25,
        tags: ['apple', 'airpods', 'audio'],
      },
      // FashionZone Products
      {
        vendorId: fashionZone._id,
        name: 'Men\'s Premium Shirt',
        slug: 'mens-premium-shirt',
        description: 'High-quality cotton formal shirt',
        categoryId: subCategories[3]._id,
        price: 3500,
        images: ['/assets/img/products/60x60/4.png'],
        stock: 50,
        isFeatured: true,
      ...
      },
      {
        ...
        categoryId: subCategories[4]._id,
        price: 4500,
        salePrice: 3500,
        images: ['/assets/img/products/60x60/5.png'],
        stock: 30,
      ...
      },
      {
        ...
        description: 'Perfect outfit for celebrations',
        categoryId: subCategories[5]._id,
        price: 2800,
        images: ['/assets/img/products/60x60/6.png'],
        stock: 20,
        tags: ['kids', 'party', 'wear'],
      },
      {
        vendorId: fashionZone._id,
        name: 'Casual Jeans',
        ...
        categoryId: subCategories[3]._id,
        price: 4000,
        images: ['/assets/img/products/60x60/7.png'],
        stock: 40,
        tags: ['men', 'jeans', 'casual'],
      },
      // BookWorld Products
      {
        vendorId: bookWorld._id,
        name: 'The Great Gatsby',
        slug: 'the-great-gatsby',
        description: 'Classic F. Scott Fitzgerald novel',
        categoryId: subCategories[6]._id,
        price: 1500,
        images: ['/assets/img/products/60x60/8.png'],
        stock: 100,
      ...
      },
      {
        ...
        categoryId: subCategories[7]._id,
        price: 2200,
        images: ['/assets/img/products/60x60/9.png'],
        stock: 50,
        isFeatured: true,
        tags: ['self-help', 'habits', 'motivation'],
      },
      {
        vendorId: bookWorld._id,
        ...
        categoryId: subCategories[6]._id,
        price: 12000,
        images: ['/assets/img/products/60x60/10.png'],
        stock: 15,
        tags: ['fiction', 'fantasy', 'harry potter'],
      },
    ]);
